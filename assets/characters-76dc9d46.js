import"./main-368a7401.js";const b="https://rickandmortyapi.com/api/character";async function g(e,s,n,o,a){try{const t=await fetch(`${b}?name=${e}&page=${a}&gender=${n}&status=${s}&species=${o}`);return console.log(t),await t.json()}catch(t){console.log(t)}}function w(e){const s=document.createElement("div");s.className="custom-modal",s.innerHTML=`
